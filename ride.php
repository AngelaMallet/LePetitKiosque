                ...
                <div class="row">
                    <div class="col l6 offset-l6">
                        <form action = "liste-patients.php" method = "POST">
                            <div class="row">
                                <div class="input-field col l6 offset-l6">
                                    <i class="material-icons prefix">search</i>
                                    <input class="center-align" type = "search" name = "terme" placeholder="Recherche...">
                               </div>
                            </div>
                            <div id="searchBtn"class="row">
                                <div class="col l6 offset-l6">
                                    <span><a href="liste-patients.php" class="btn-floating btn-small waves-effect waves-light transparent "><i class="material-icons blue-grey-text">clear</i></a></span>
                                    <input class=" btn-small blue-grey-text transparent z-depth-2" type="submit" name = "s" value = "Rechercher">
