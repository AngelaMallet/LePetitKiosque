			...
			<div id="serviceRow" class="row center-align">
				<div class="col s12 m4">
					<div class="card">
						...
						<div class="card-content">
							<a class="waves-effect waves-light btn-large red white-text accent-1"><p>COVOITURAGE</p></a>
				...
				<div class="col s12 m4">
					<div class="card">
						...
						<div class="card-content">
							<a class="waves-effect waves-light btn-large red white-text accent-1"><p>COURSES</p></a>
				...
				<div class="col s12 m4">
					<div class="card">
						...
						<div class="card-content">
							<a class="waves-effect waves-light btn-large red white-text accent-1"><p>TRAJET SCOLAIRE</p></a>
						</div>				
					</div>
